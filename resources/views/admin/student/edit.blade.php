                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('students.update', $student) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="cne" type="text" class="form-control @error('cne') is-invalid @enderror" name="cne" value="{{ $student->cne }}" required autocomplete="cne">
                                ...
                                <div class="col-md-6">
                                    <select name="filiere_id" class="custom-select" id="inputGroupSelect01">
                                        ...
                                        @foreach ($filieres as $filiere)
                                            <option value="{{ $filiere->id }}" @if ($filiere->id == $student->filiere_id) selected @endif>{{ $filiere->filiere }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
